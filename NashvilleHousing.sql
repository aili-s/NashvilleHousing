...
--			Remove Duplicates
--The standard method for finding duplicates is to use the "DISTINCT" function on a column, such as UniqueID. A possible option is with a temporary table (described here)
